...
values
  ('media_file', 'presentation:world-around-me-lesson-1', 'Презентация урока 1', 'Google Slides для урока 1', 'https://docs.google.com/presentation/d/1o-LCuePhdVq39oBPqHgtHpJUREJNz4dS/edit?usp=drive_link&ouid=102261836036017130249&rtpof=true&sd=true', '{}'::jsonb),
  ('media_file', 'flashcards:world-around-me-lesson-1', 'Карточки урока 1 (PDF)', 'Карточки для работы на уроке 1', 'https://drive.google.com/file/d/11LTKea4ui3_xB5ZBc6WbEanwlxfoO_GY/view?usp=drive_link', '{}'::jsonb),
  ('worksheet', 'worksheet:appendix-1', 'Приложение 1', 'Материал для счёта и указки.', 'https://drive.google.com/file/d/1hNwwBZ0S7SNmSbAAt-vz1aPanAluSTrC/view?usp=drive_link', '{}'::jsonb),
  ('worksheet', 'worksheet:workbook-pages-3-4', 'Рабочая тетрадь, стр. 3–4', 'Закрепление урока 1.', 'https://drive.google.com/file/d/1bS3KP_wRQSrAu9faPhyqkNdxeTul9bi0/view?usp=drive_link', '{}'::jsonb),
  ('video', 'video:farm-animals', 'farm animals', 'Видео урока 1.', 'https://drive.google.com/file/d/1NXyngOuT9WIwvgA0gvvSzZc9-BUuKT7k/view?usp=drive_link', '{}'::jsonb),
  ('song', 'song:farm-animals', 'farm animals', 'Песня урока 1.', 'https://drive.google.com/file/d/1RewHJRdd6oqSfX506A7ABt6VMDhDzJRP/view?usp=drive_link', '{}'::jsonb),
  ('video', 'song-video:farm-animals-movement', 'farm animals (movement version)', 'Видео-версия песни с движением.', 'https://drive.google.com/file/d/1RdZLmZHFnxflYuYkSNvhclrfYuNxAnSC/view?usp=drive_link', '{}'::jsonb),
  ('media_file', 'pronunciation:dog', '狗 · gǒu', null, 'https://drive.google.com/file/d/1grQp68jzA-GKI-347k_FCcioEFdpUeIa/view?usp=drive_link', '{}'::jsonb),
  ('media_file', 'pronunciation:cat', '猫 · māo', null, 'https://drive.google.com/file/d/1Q-nHIC2le2LncKp0ShW5VjVpShCeAfo-/view?usp=drive_link', '{}'::jsonb),
  ('media_file', 'pronunciation:rabbit', '兔子 · tùzi', null, 'https://drive.google.com/file/d/1bsr-B0VChwBtbAtzUYWw3XxNOm8tdQ0H/view?usp=drive_link', '{}'::jsonb),
  ('media_file', 'pronunciation:horse', '马 · mǎ', null, 'https://drive.google.com/file/d/1eOPR9ijCZCZYK2JlKy4QfhdMdqiENzUc/view?usp=drive_link', '{}'::jsonb),
  ('media_file', 'pronunciation:farm', '农场 · nóngchǎng', null, 'https://drive.google.com/file/d/12fQ1TLKBpoZ7GWgcJ1VQ4NIbc1W16Tpv/view?usp=drive_link', '{}'::jsonb),
  ('media_file', 'pronunciation:wo-shi', '我是… · wǒ shì…', null, 'https://drive.google.com/file/d/1ifEjsJxsrtrlae9UALLC4z59DAFN9XfM/view?usp=drive_link', '{}'::jsonb),
  ('media_file', 'pronunciation:zhe-shi', '这是… · zhè shì…', null, 'https://drive.google.com/file/d/1FryGPVixCPSoPI1-NhsFKaCz7_QFjuxj/view?usp=drive_link', '{}'::jsonb),
  ('media_file', 'pronunciation:run', '跑 · pǎo', null, 'https://drive.google.com/file/d/1FErrO1KK31rE0m1iCua2WjAyh9TWtodX/view?usp=drive_link', '{}'::jsonb),
  ('media_file', 'pronunciation:jump', '跳 · tiào', null, 'https://drive.google.com/file/d/1zEgYecw45dyHxbzR0LterPNIWBZtl4Rr/view?usp=drive_link', '{}'::jsonb),
  ('media_file', 'pronunciation:lets', '我们…吧! · wǒmen … ba!', null, 'https://drive.google.com/file/d/1nqGYhDcqVRANWl7-R_jcC9vrZ2t_VLFB/view?usp=drive_link', '{}'::jsonb),
  ('media_file', 'pronunciation:zai', '在 · zài', null, 'https://drive.google.com/file/d/15n4D2hLmnlRdcGjG1SlXvHyr1UV6R8qZ/view?usp=drive_link', '{}'::jsonb)
on conflict (slug)
do update set
  kind = excluded.kind,
