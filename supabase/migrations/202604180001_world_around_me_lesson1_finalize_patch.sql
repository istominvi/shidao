...
values
  ...
  ('song', 'song:farm-animals', 'farm animals', 'Песня урока 1.', 'https://drive.google.com/file/d/1RewHJRdd6oqSfX506A7ABt6VMDhDzJRP/view?usp=drive_link', '/methodologies/world-around-me/lesson-1/media/farm-animals-song.mp3', '{}'::jsonb),
  ('video', 'song-video:farm-animals-movement', 'farm animals (movement version)', 'Видео-версия песни с движением.', 'https://drive.google.com/file/d/1RdZLmZHFnxflYuYkSNvhclrfYuNxAnSC/view?usp=drive_link', '/methodologies/world-around-me/lesson-1/media/farm-animals-song-video.mp4', '{}'::jsonb),
  ('media_file', 'pronunciation:dog', '狗 · gǒu', null, null, '/methodologies/world-around-me/lesson-1/audio/gou.mp3', '{}'::jsonb),
  ('media_file', 'pronunciation:cat', '猫 · māo', null, null, '/methodologies/world-around-me/lesson-1/audio/mao.mp3', '{}'::jsonb),
  ('media_file', 'pronunciation:rabbit', '兔子 · tùzi', null, null, '/methodologies/world-around-me/lesson-1/audio/tuzi.mp3', '{}'::jsonb),
  ('media_file', 'pronunciation:horse', '马 · mǎ', null, null, '/methodologies/world-around-me/lesson-1/audio/ma.mp3', '{}'::jsonb),
  ('media_file', 'pronunciation:farm', '农场 · nóngchǎng', null, null, '/methodologies/world-around-me/lesson-1/audio/nongchang.mp3', '{}'::jsonb),
  ('media_file', 'pronunciation:wo-shi', '我是… · wǒ shì…', null, null, '/methodologies/world-around-me/lesson-1/audio/woshi.mp3', '{}'::jsonb),
  ('media_file', 'pronunciation:zhe-shi', '这是… · zhè shì…', null, null, '/methodologies/world-around-me/lesson-1/audio/zheshi.mp3', '{}'::jsonb),
  ('media_file', 'pronunciation:run', '跑 · pǎo', null, null, '/methodologies/world-around-me/lesson-1/audio/pao.mp3', '{}'::jsonb),
  ('media_file', 'pronunciation:jump', '跳 · tiào', null, null, '/methodologies/world-around-me/lesson-1/audio/tiao.mp3', '{}'::jsonb),
  ('media_file', 'pronunciation:lets', '我们…吧! · wǒmen … ba!', null, null, '/methodologies/world-around-me/lesson-1/audio/womenba.mp3', '{}'::jsonb),
  ('media_file', 'pronunciation:zai', '在 · zài', null, null, '/methodologies/world-around-me/lesson-1/audio/zai.mp3', '{}'::jsonb)
on conflict (slug)
do update set
  kind = excluded.kind,
