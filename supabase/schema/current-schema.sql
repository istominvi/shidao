...
-- Generated by scripts/refresh-schema-snapshot.sh on 2026-08-07T09:54:34Z
-- Learner identity release stage: expand
...
REVOKE ALL ON FUNCTION public.can_read_class(p_class_id uuid) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.clear_user_pin(p_user_id uuid) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.ensure_user_preference(p_user_id uuid) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.ensure_user_security(p_user_id uuid) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.get_last_active_profile(p_user_id uuid) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.is_class_student(p_class_id uuid) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.is_class_teacher(p_class_id uuid) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.is_my_child(p_student_id uuid) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.merge_user_settings(p_user_id uuid, p_settings jsonb) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.onboard_parent(p_user_id uuid, p_full_name text) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.onboard_teacher(p_user_id uuid, p_full_name text) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.parent_in_class(p_class_id uuid) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.parent_in_school(p_school_id uuid) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.reset_pin_attempts(p_user_id uuid) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.set_last_active_profile(p_user_id uuid, p_profile text) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.set_last_selected_school(p_user_id uuid, p_school_id uuid) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.set_user_pin(p_user_id uuid, p_raw_pin text) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.teaches_student(p_student_id uuid) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.upsert_user_theme(p_user_id uuid, p_theme text) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.verify_user_pin(p_user_id uuid, p_raw_pin text) FROM PUBLIC;
