        ...
        <div className="model-principles-grid">
          ...
          {[
            [
              ...
              "Пройденные занятия, ответы, ошибки и подтверждённые знания сохраняются в учебном профиле. Курс, преподаватель или школа могут измениться — образовательный путь продолжается.",
            ],
            [
              "02",
              "Урок ≠ проведение",
              "Урок — это редактируемый сценарий внутри курса, а проведение — отдельное событие с датой, режимом и результатами. Один сценарий можно использовать многократно, не смешивая разные сессии.",
            ],
            [
              "03",
              "Материал подключается, а не копируется",
              "Тест, карточка, видео, упражнение или игра живут в едином каталоге и подключаются к разным урокам. Материал улучшается в одном месте, а актуальная версия появляется везде.",
            ],
            [
              "04",
              "AI действует через MCP и инструменты",
              "AI создаёт и редактирует курсы, отдельные уроки и материалы, помогает проводить занятия, анализирует метрики и ведёт учебный профиль. Каждое действие проходит через функции ShiDao с проверкой прав, структуры данных и журналом изменений.",
            ],
