          ...
          <div className="model-account-points">
            <article>
              ...
              <div>
                ...
                <p className="model-copy-body">
                  ...
                  помогает своему ребёнку.
                </p>
                <p className="model-copy-body">
                  Взрослый может входить по электронной почте или номеру телефона
                  с паролем. Для ребёнка образовательный профиль может
                  существовать без полноценного взрослого аккаунта: достаточно
                  уникального логина и короткого PIN-кода, которым управляет
                  родитель или другой доверенный взрослый. Позднее к этому
                  профилю можно подключить собственный аккаунт ребёнка, не теряя
                  накопленную историю.
                </p>
              </div>
            </article>
            ...
            <article>
              ...
              <div>
                ...
                <p className="model-copy-body">
                  ...
                  образовательный профиль, он может учиться сам.
                </p>
                <p className="model-copy-body">
                  Эти возможности могут существовать одновременно и дополнять
                  друг друга. Человеку не нужно регистрироваться заново или
                  решать, какую роль выбрать навсегда: меняются его задачи и
                  связи внутри системы, но сам аккаунт остаётся прежним.
                </p>
              </div>
            </article>
            ...
            <article>
              ...
              <div>
                ...
                <p className="model-copy-body">
                  Поэтому один аккаунт может быть владельцем курсов, проводить
                  занятия, управлять профилем ребёнка и одновременно иметь
                  собственный образовательный профиль. Данные не дублируются
                  между ролями, а учебная история остаётся связанной с конкретным
                  человеком и сохраняется независимо от того, как со временем
                  меняется его участие в образовании.
                </p>
              </div>
            </article>
          </div>
