      ...
      <section className="model-ai-section" id="ai">
        <div className="model-ai-section-inner">
          ...
          <div className="model-ai-safety">
            <div className="model-ai-contour-head">
              <span className="model-card-label model-card-label-dark">
                ЕДИНЫЙ УПРАВЛЯЕМЫЙ КОНТУР
              </span>
              <h2>
                ИИ получает не прямой доступ к Shidao, а разрешённый контекст и
                набор действий
              </h2>
            </div>

            <div className="model-ai-contour-intro">
              <p>
                Встроенный ассистент Shidao и подключаемые внешние модели
                работают через один контролируемый слой. Shidao определяет,
                какие данные модель может увидеть, какие инструменты
                использовать и какие изменения выполнить.
              </p>
              <p>
                Перед каждым действием система проверяет пользователя, его права
                и параметры запроса. Важные или необратимые изменения требуют
                подтверждения, а выполненные операции сохраняются в истории.
              </p>
              <p>
                Поэтому ИИ-модель можно подключить, обновить или заменить без
                перестройки образовательного процесса. Курсы, уроки, результаты
                и образовательная память остаются внутри Shidao и доступны
                следующей модели по тем же правилам.
              </p>
            </div>

            <div className="model-ai-contour-process">
              <span className="model-card-label model-card-label-dark">
                КАК РАБОТАЕТ КОНТУР
              </span>
              <div className="model-ai-contour-steps">
                {[
                  {
                    title: "Получает контекст",
                    text: "ИИ получает только те данные, которые нужны для текущей задачи и доступны конкретному пользователю: образовательную цель, курс, урок, материалы и разрешённую часть учебного профиля.",
                    Icon: FileStack,
                  },
                  {
                    title: "Выбирает разрешённое действие",
                    text: "Модель может использовать только предоставленные Shidao инструменты: найти курс или материал, создать урок, предложить изменение, назначить домашнее задание или сохранить результат занятия.",
                    Icon: MousePointer2,
                  },
                  {
                    title: "Проходит проверку",
                    text: "Shidao проверяет пользователя, его связь с конкретным курсом или образовательным профилем, доступные ему действия и корректность запроса.",
                    Icon: LockKeyhole,
                  },
                  {
                    title: "Показывает изменения человеку",
                    text: "Значимые изменения не применяются незаметно. Пользователь видит, что именно предлагает изменить ИИ, и подтверждает действие, когда это необходимо.",
                    Icon: CheckCircle2,
                  },
                  {
                    title: "Сохраняет результат",
                    text: "Выполненное действие фиксируется в истории. Результаты занятия — ответы, ошибки, темп, прогресс и подтверждённые наблюдения — пополняют образовательный профиль.",
                    Icon: History,
                  },
                  {
                    title: "Продолжает процесс с обновлённым контекстом",
                    text: "Накопленная история становится контекстом для следующих решений. Её может использовать встроенный ассистент Shidao или другая подключённая модель — без потери непрерывности образовательного пути.",
                    Icon: Route,
                  },
                ].map(({ title, text, Icon }, index) => (
                  <article key={title}>
                    <div className="model-ai-contour-step-head">
            ...
            <div className="model-ai-contour-bottom">
              <div
                className="model-ai-contour-schema"
                aria-label="Схема управляемого контура Shidao"
              >
                {[
                  {
                    title: "ИИ-модели",
                    text: "встроенный ассистент · внешние модели и агенты",
                    Icon: Bot,
                  },
                  {
                    title: "Управляемый контур Shidao",
                    text: "контекст · разрешённые инструменты · проверка прав · подтверждение · история операций",
                    Icon: WandSparkles,
                  },
                  {
                    title: "Образовательный процесс",
                    text: "курс · урок · занятие · домашняя работа · общение",
                    Icon: Route,
                  },
                  {
                    title: "Образовательный профиль",
                    text: "результаты · знания · ошибки · наблюдения · подтверждённые выводы",
                    Icon: CircleUserRound,
                  },
                  {
                    title: "Контекст для следующего решения",
                    text: "",
                    Icon: History,
                  },
                ].map(({ title, text, Icon }, index, items) => (
                  <div className="model-ai-contour-schema-item" key={title}>
                    <div>
                      <Icon size={20} />
                      <span>
                        <strong>{title}</strong>
                    ...
                    {index < items.length - 1 && <ArrowDown size={18} />}
                  </div>
                ))}
              </div>

              <div className="model-ai-contour-thesis">
                <span className="model-card-label model-card-label-dark">
                  ФИНАЛЬНЫЙ ТЕЗИС
                </span>
                <blockquote>
                  ИИ в Shidao — заменяемый исполнитель, а не владелец
                  образовательного процесса.
                </blockquote>
                <p>
                  Модели могут меняться, но правила работы, накопленная история
                  и контроль над действиями остаются в Shidao.
                </p>
              </div>
            </div>

            <div className="model-ai-contour-next">
              <ArrowDown size={20} />
              <p>
                То, как сохранённые результаты влияют на содержание и сложность
                следующего урока, показано ниже — в продуктовом цикле Shidao.
              </p>
            </div>
          </div>
