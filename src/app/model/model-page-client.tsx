          ...
          <div className="model-experience-points">
            ...
            <article>
              ...
              <div>
                ...
                <p className="model-copy-body">
                  ...
                  методики, книги, конспекты, документы, аудио, видео и ссылки.
                  ИИ может подготовить весь маршрут сразу или создать только
                  первый урок, чтобы каждый следующий формировался с учётом
                  реальных результатов ученика.
                </p>
              </div>
            </article>
            ...
            <article>
              ...
              <div>
                ...
                <p className="model-copy-body">
                  Для каждого шага преподаватель или ИИ определяет, какие
                  элементы должны появиться на Экране ученика, тогда как
                  методический план и внутренние заметки остаются скрытыми. Во
                  время занятия переходами между шагами управляет преподаватель,
                  поэтому все участники видят нужный материал в нужный момент.
                  После завершения тот же экран открывается для свободного
                  повторения, а отдельное Домашнее задание может быть общим для
                  группы или персональным для конкретного ученика.
                </p>
              </div>
            </article>
          </div>
