      ...
      <div className="auth-shell-grid">
        ...
        <div className="primary-form-card">
          ...
          <p className="mt-2 text-sm text-neutral-600">
            Подтвердите адрес и вернитесь ко входу. Это защитит ваш взрослый
            аккаунт.
          </p>
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            <Link
              href={ROUTES.login}
              className="landing-btn landing-btn-primary min-h-12 w-full"
            >
              Перейти ко входу
            </Link>
            <Link
              href={ROUTES.join}
              className="landing-btn landing-btn-muted min-h-12 w-full border-black/15"
            >
              Изменить email
            </Link>
          </div>
