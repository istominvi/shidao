...
import { getUserContextById, setLastActiveProfile } from '@/lib/server/supabase-admin';
...
export async function POST(req: NextRequest) {
  ...
  if (context.actorKind !== 'adult' || !context.availableAdultProfiles.includes(body.profile)) {
