      ...
      <div className="container space-y-6 py-7 md:py-10">
        ...
        <AppCard className="space-y-3 p-5">
          <p className="text-sm text-neutral-700">
            Методика: <span className="font-semibold text-neutral-900">{readModel.methodology.title}</span>
          </p>
          <p className="text-sm leading-6 text-neutral-700">
            Это source-урок без привязки к группе и времени. Чтобы провести его как runtime-занятие, нажмите «Назначить урок» и выберите группу/дату.
          </p>
          {readModel.passport.lessonFormatSummary ? (
            <p className="text-sm leading-6 text-neutral-700">
              <span className="font-semibold text-neutral-900">Формат:</span> {readModel.passport.lessonFormatSummary}
            </p>
          ) : null}
        </AppCard>
