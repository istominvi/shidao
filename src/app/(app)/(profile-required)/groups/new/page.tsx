...
export default async function NewGroupPage({
  ...
  async function createGroupAction(formData: FormData) {
    ...
    try {
      ...
      const created = await createClassForTeacherAdmin({ teacherId, name });
    ...
    <main className="pb-12">
      ...
      <div className="container py-7 md:py-10">
        <section className="landing-surface rounded-3xl border border-white/80 p-6 md:p-8">
          ...
          <p className="mt-2 text-sm text-neutral-700">Минимальный рабочий поток: создаёт группу и сразу привязывает её к преподавателю.</p>
