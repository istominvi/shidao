...
export const lessonContentFixtureMethodology: Methodology = {
  ...
  metadata: {
    ...
    teachingApproachSummary:
      "Коммуникативная игровая методика: дети слушают, говорят, двигаются и закрепляют материал через мультисенсорные активности.",
    learningOutcomes: [
      "Формируют активный словарь по бытовым и тематическим темам курса.",
      "Осваивают базовые речевые модели и короткие коммуникативные реплики.",
      "Развивают уверенное listening + speaking поведение в детской группе.",
      "Используют китайский в движении, играх и ситуационных мини-диалогах.",
    ],
    thematicModules: [
      "Животные, окружающий мир и повседневные объекты ребёнка.",
      "Семья, дом, еда, повседневные действия и социальные ритуалы.",
      "Игровые коммуникативные сценарии с речевыми паттернами урока.",
    ],
    methodologyNotes: [
      "Каждый урок начинается и заканчивается песней для устойчивого ритуала входа/выхода.",
      "Стандарт урока — 14–16 активностей с чередованием ритма: видео, движение, карточки, рабочая тетрадь, игра.",
      "В плане урока важны teacher prompts и ожидаемые ответы детей — это ядро управляемой практики.",
    ],
    materialsEcosystemSummary:
      "Карточки слов/фраз, реквизит и props, рабочая тетрадь, игровые материалы, песни и видео-сегменты по темам.",
    courseScopeLabel:
      "Полная программа: учебный год, 21 песня + 21 видео и тематические уроки с наращиванием словаря.",
    availableLessonsNote:
      "В ShiDao сейчас загружена часть программы: 1 урок из методики для пилотного планирования.",
  },
};
