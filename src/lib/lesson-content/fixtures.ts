...
export const lessonContentFixtureMethodology: Methodology = {
  ...
  metadata: {
    ...
    teachingApproachSummary:
      "Коммуникативная игровая методика: multisensory-активности, ритм песня-видео-движение и развитие listening + speaking.",
    learningOutcomes: [
      "Ребёнок понимает и использует базовые слова/фразы по темам курса в устной речи.",
      "Уверенно отвечает на вопросы преподавателя короткими целевыми репликами.",
      "Развивает аудирование и произношение через песни, видео и повторяющиеся паттерны.",
      "Переносит лексику в игровые и коммуникативные ситуации в группе.",
    ],
    thematicModules: [
      "Я и мои эмоции",
      "Семья, дом и предметы вокруг",
      "Животные, природа и времена года",
      "Еда, игры, повседневные действия",
      "Праздники, культура и социальные ситуации",
    ],
    methodologyNotes: [
      "Каждый урок обычно включает 14–16 активностей, стартует и заканчивается песней.",
      "Планы уроков содержат teacher prompts и ожидаемые ответы детей — важно сохранять этот scaffold.",
      "Для устойчивого темпа рекомендуется придерживаться группы 4–6 детей; верхний предел — 8.",
    ],
    materialsEcosystemSummary:
      "Карточки слов/фраз, реквизит, игрушки, рабочая тетрадь, песни и видео в едином сценарии урока.",
    lessonActivityLoadLabel: "Обычно 14–16 активностей за урок",
    lessonFormatSummary:
      "Песня → ввод/просмотр → лексика и teacher prompts → активные игры/движение → worksheet → песня/рекап.",
    courseScopeLabel:
      "Полная программа рассчитана на учебный год и включает расширенный набор тем и уроков.",
    availableLessonsLabel:
      "В ShiDao сейчас загружена часть программы; остальные уроки добавляются поэтапно.",
  },
};
