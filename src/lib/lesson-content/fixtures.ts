...
export const lessonContentFixtureMethodology: Methodology = {
  ...
  metadata: {
    ...
    audienceLabel: "Дошкольники 5–6 лет",
    targetAgeLabel: "5–6 лет",
    lessonDurationLabel: "45 минут",
    courseDurationLabel: "1 учебный год · сентябрь–июнь",
    courseScopeLabel: "Годовая программа с поэтапным расширением словаря и речи",
    approximateVocabularyCount: 180,
    songCount: 21,
    videoCount: 21,
    idealGroupSizeLabel: "4–6 детей",
    maxGroupSize: 8,
    activitiesPerLessonLabel: "Обычно 14–16 активностей",
    lessonFormatSummary:
      "Каждый урок открывается и завершается песней, а ядро построено на смене видео, движения, игр и практических заданий.",
    teachingApproachSummary:
      "Коммуникативный, activity-based и мультисенсорный формат: слушание + говорение через игровые сценарии, движение и наглядные опоры.",
    learningOutcomes: [
      "Понимать и использовать базовые слова и фразы по темам курса в устной речи.",
      "Реагировать на инструкции преподавателя и участвовать в коротких диалогах по модели.",
      "Развивать слуховое восприятие китайской речи через регулярную работу с песнями и видео.",
      "Укреплять уверенность в говорении через ролевые и подвижные игры.",
    ],
    thematicModules: [
      "Я и моё окружение: семья, друзья, повседневные роли.",
      "Мир вокруг: животные, предметы, цвета, числа и действия.",
      "Режим дня и сезонные темы: погода, праздники, привычки и события года.",
      "Коммуникативные мини-ситуации: вопросы-ответы, просьбы, короткие диалоги.",
    ],
    methodologyNotes: [
      "Методика ориентирована на малые группы и высокую включённость каждого ребёнка.",
      "Если в группе больше 6 детей, заранее планируйте парную и станционную ротацию активностей.",
      "Уроки предполагают предварительную подготовку реквизита, карточек и пространства в классе.",
    ],
    materialsEcosystemSummary:
      "Курс использует связку песен, видеосегментов, карточек, реквизита, игровых шаблонов и страниц рабочей тетради.",
