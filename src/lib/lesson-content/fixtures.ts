...
export const lessonContentFixtureMethodology: Methodology = {
  ...
  title: "我周围的世界",
  shortDescription:
    "Мир вокруг меня: китайский для детей 5–6 лет, 45-минутные занятия с песнями, видео и активной игровой практикой.",
  metadata: {
    locale: "zh-CN",
    level: "Beginner (YL 5–6)",
    ...
    maxGroupSize: 8,
    audienceSummary:
      "Дошкольники 5–6 лет, начинающие изучать китайский язык через движение, ритм и игру.",
    courseScopeSummary:
      "Годовая коммуникативная программа с тематическими модулями, песнями, видео и игровой практикой.",
    teachingApproachSummary:
      "Коммуникативный, activity-based и мультисенсорный формат с акцентом на listening + speaking.",
    learningOutcomes: [
      "Ребёнок понимает и использует базовые слова и фразы по темам программы.",
      "Учащийся уверенно участвует в коротких диалогах и игровых инструкциях на китайском.",
      "Дети развивают слуховое восприятие и произношение через песни, видео и ритмическое повторение.",
      "Формируется устойчивая привычка к активному участию в парных и групповых заданиях.",
    ],
    thematicModules: [
      "Я и мой мир (семья, части тела, повседневные действия)",
      "Окружающий мир (животные, еда, предметы, природа)",
      "Социальные ситуации (приветствие, просьба, простые диалоги)",
      "Календарные и сезонные темы в течение учебного года",
    ],
    methodologyNotes: [
      "Каждый урок обычно включает 14–16 активностей и начинается/заканчивается песней.",
      "План урока содержит явные teacher prompts и ожидаемые student responses.",
      "Методика рассчитана на малую группу; при превышении 8 детей снижается качество практики.",
    ],
    materialsEcosystemSummary:
      "Карточки слов и фраз, реквизит, song/video-медиа, рабочая тетрадь и игровые предметы для активностей.",
    formatHighlights: [
      "Игровая практика с движением и сменой темпа активностей.",
      "Связка видео + песня + карточки + речевые шаблоны в каждом занятии.",
      "Подготовка материалов до урока — обязательная часть сценария.",
    ],
    sourceImportStatusNote:
      "Полная программа шире текущего набора уроков, импортированных в ShiDao на этом этапе.",
  },
};
