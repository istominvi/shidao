...
const lessonOneTeacherFallbackByOrder: Record<number, Omit<MethodologyLessonStep["teacher"], "description"> & {
  ...
  2: {
    ...
    teacherScript: ["这是狗。Zhè shì gǒu.", "这是猫。Zhè shì māo.", "这是什么？"],
  ...
  4: {
    ...
    teacherScript: ["这是兔子。Zhè shì tùzi.", "请找马。Qǐng zhǎo mǎ."],
    expectedResponses: ["狗 / 猫 / 兔子 / 马"],
  ...
  5: {
    ...
    teacherScript: ["我们学马吧！Wǒmen xué mǎ ba!", "我们学兔子吧！Wǒmen xué tùzi ba!"],
  ...
  6: {
    ...
    teacherScript: ["球来了，找狗！", "猫在哪里？Māo zài nǎlǐ?"],
    expectedResponses: ["Показывают 狗/猫/兔子/马", "Коротко называют слово"],
  ...
  8: {
    ...
    teacherScript: ["数一数：几只狗？Shǔ yī shǔ: jǐ zhī gǒu?", "说：三只兔子。Sān zhī tùzi."],
    expectedResponses: ["一只狗 / 两只猫 / 三只兔子", "Число + животное по модели"],
  ...
  10: {
    ...
    teacherScript: ["跑到马！Pǎo dào mǎ!", "跳到兔子！Tiào dào tùzi!"],
  ...
  11: {
    ...
    teacherScript: ["狗在做什么？Gǒu zài zuò shénme?", "马跑。兔子跳。"],
    expectedResponses: ["马跑。", "兔子跳。", "猫跳。"],
  ...
  14: {
    ...
    teacherScript: ["谁在农场里？Shéi zài nóngchǎng lǐ?", "猫在农场里。"],
    expectedResponses: ["狗在农场里。", "马在农场里。", "兔子在农场里。"],
