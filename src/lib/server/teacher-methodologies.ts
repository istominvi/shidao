...
function collectStudentContentAssetIds(
  studentContent: NonNullable<
  ...
  return {
    ...
    lessons: lessonsWithHomework.map(({ lesson, canonicalHomework }) => {
      ...
      return {
        ...
        stepsCount: lesson.blocks.length,
        newWordsCount: lesson.shell.vocabularySummary.length,
        newPhrasesCount: lesson.shell.phraseSummary.length,
