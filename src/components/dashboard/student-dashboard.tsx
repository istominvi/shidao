    ...
    >
      <div className="grid gap-4 md:grid-cols-2">
        <article className="dashboard-grid-card bg-[linear-gradient(140deg,rgba(112,183,255,0.22),rgba(255,255,255,0.9))]">
          ...
          <p className="mt-2 text-sm text-neutral-700">27 марта · 17:00 · Zoom-ссылка от преподавателя</p>
        </article>
        <article className="dashboard-grid-card bg-[linear-gradient(140deg,rgba(255,182,232,0.24),rgba(255,255,255,0.9))]">
          ...
          <p className="mt-2 text-sm text-neutral-700">Урок 5: аудио + карточки иероглифов. Срок: 28 марта, 20:00.</p>
        </article>
      </div>
    </DashboardShell>
  );
