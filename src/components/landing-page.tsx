...
const audienceCards = [
  {
    ...
    icon: GraduationCap,
    points: [
      "Ведёт группы и уроки в единой структуре.",
      "Работает по встроенной методике — без хаоса в материалах.",
      "Назначает домашние задания группе или ученику.",
      "Обсуждает прогресс прямо в треде нужного урока.",
    ],
  },
  {
    id: "parent",
    ...
    icon: UserRound,
    points: [
      "Видит актуальное расписание ребёнка.",
      "Следит за заданиями и статусом выполнения.",
      "Получает комментарии по урокам и домашней работе.",
      "Понимает, как ребёнок движется по программе.",
    ],
  },
  {
    id: "student",
    ...
    points: [
      ...
      "Открывает урок и материалы в нужном порядке.",
      "Сдаёт домашние задания текстом, файлом или голосом.",
      "Обсуждает вопросы в треде именно своего занятия.",
    ],
  },
];
