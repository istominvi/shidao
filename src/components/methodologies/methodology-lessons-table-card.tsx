...
function MethodologyLessonsTable({ methodologySlug, rows }: Pick<MethodologyLessonsTableCardProps, "methodologySlug" | "rows">) {
...
export function MethodologyLessonsTableCard({
  ...
  if (embedded) {
    return <MethodologyLessonsTable methodologySlug={methodologySlug} rows={rows} />;
  }
