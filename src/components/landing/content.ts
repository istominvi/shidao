...
export const LANDING_VALUE_STRIP = [
...
export const LANDING_COMPARISON_BEFORE = [
...
export const LANDING_COMPARISON_AFTER = [
...
export const LANDING_FIRST_METHOD_STATS = [
  "5–6 лет",
  "1 учебный год",
  "~180 слов",
  "21 песня",
...
export type LandingIconStep = {
  title: string;
  icon: LucideIcon;
};

export const LANDING_METHOD_FLOW_STEPS: LandingIconStep[] = [
...
export const LANDING_LESSON_COMPOSITION: Array<{
  title: string;
  subtitle: string;
  icon: LucideIcon;
}> = [
...
export const LANDING_ROLE_CARDS: Array<{
  title: string;
  icon: LucideIcon;
  tone: "teacher" | "parent" | "student";
  description: string;
  points: string[];
}> = [
  {
