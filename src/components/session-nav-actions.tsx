  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className={`landing-btn landing-btn-muted nav-action-trigger inline-flex cursor-pointer items-center gap-1.5 border-black/10 bg-white/90 px-1.5 py-0.5 ${variant === "landing" ? "w-full justify-center sm:w-auto" : ""}`}
      >
